...
public class AppointmentTest {
    ...
    public void durationIsCalculatedCorrectlyWithDtend() {
        ...
        Appointment appointment = new Appointment(startDate, endDate, "Meeting", "Team meeting", "filename");
    ...
    public void durationIsCorrectlySetWithIcsDurationHoursAndMinutes() {
            ...
            OurDateTime startDate = new OurDateTime(2022, 1, 1, 10, 0);
            Appointment appointment = new Appointment(startDate, durationFromString, "Meeting", "Team meeting", "filename");
